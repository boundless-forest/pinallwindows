...
- `screenshots/screenshot-01-side-panel.png`: cross-window tab management.
...
The promotional artwork and screenshots use bundled Manrope typography, exact Chrome Web Store dimensions, and no alpha channel. Rebuild all assets with `pnpm assets:store`. Follow `store-listing/ARTWORK.md` for the screenshot order, source capture guidance, and verification rules.
